...
public enum ErrorCode implements BaseCode {
    ...
    INTERNAL_SERVER_ERROR("COMMON500", "서버 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),

    // Validation
    VALIDATION_ERROR("VALID400", "요청 값이 유효하지 않습니다.", HttpStatus.BAD_REQUEST),

    // DB
    DATABASE_ERROR("DB500", "데이터 처리 중 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR);
